...
const sortTasks = (tasks) => {
  ...
  tasks.sort((a, b) => isServer2 || a.$el$ === b.$el$ ? a.$index$ < b.$index$ ? -1 : 1 : 2 & a.$el$.compareDocumentPosition(getRootNode(b.$el$)) ? 1 : -1);
};
...
const createQRL = (chunk, symbol, symbolRef, symbolFn, capture, captureRef, refSymbol) => {
  ...
  return Object.assign(qrl, {
    ...
    dev: null,
    resolved: void 0
  }), symbolRef && maybeThen(symbolRef, (resolved) => qrl.resolved = symbolRef = resolved), qrl;
};
...
const _useStyles = (styleQrl, transform, scoped) => {
  ...
  return isPromise(value) ? iCtx.$waitOn$.push(value.then(appendStyle)) : appendStyle(value), styleId;
};
...
export {
  ...
  noSerialize as w,
  createContextId as x,
  useLexicalScope as y,
  getLocale as z
};
